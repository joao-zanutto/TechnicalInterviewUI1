...
using TechnicalInterviewUI.Data;
using TechnicalInterviewUI.Services;

namespace TechnicalInterviewUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDocumentInputRepository, DocumentInputRepository>();
        }
